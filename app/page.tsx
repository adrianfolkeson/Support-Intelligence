...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="bg-primary px-4 py-32 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl text-center">
          ...
          <p className="mt-6 text-lg text-neutral-200 sm:text-xl lg:mx-auto lg:max-w-2xl">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              <div key={feature.title} className="rounded-2xl bg-white p-8 shadow-card border border-neutral-200">
      ...
      <section className="bg-neutral-900 px-4 py-24 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
            <div className="text-center">
              ...
              <p className="mt-4 text-4xl font-bold text-neutral-900">50+</p>
              <p className="mt-2 text-neutral-600">SaaS Companies</p>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center">
                <BarChart3 className="h-8 w-8 text-neutral-700" />
              </div>
              <p className="mt-4 text-4xl font-bold text-neutral-900">2.5M+</p>
              <p className="mt-2 text-neutral-600">Tickets Analyzed</p>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center">
                <TrendingUp className="h-8 w-8 text-neutral-700" />
              </div>
              <p className="mt-4 text-4xl font-bold text-neutral-900">34%</p>
              <p className="mt-2 text-neutral-600">Avg. Churn Reduction</p>
            </div>
          </div>
        </div>
      </section>
              ...
              <Card key={study.company} className="overflow-hidden">
                <div className="bg-neutral-900 px-6 py-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-medium text-neutral-300">{study.industry}</span>
                  </div>
                </div>
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold text-neutral-900">{study.company}</h3>
                  <div className="mt-4 space-y-3">
                    {study.metrics.map((metric) => (
                      <div key={metric.label} className="flex items-center justify-between">
                        <span className="text-sm text-neutral-600">{metric.label}</span>
                        <div className="flex items-center gap-1">
                          {metric.improvement === "down" && <TrendingUp className="h-4 w-4 text-success rotate-180" />}
                          {(metric.improvement === "up" || metric.improvement === "improvement") && <TrendingUp className="h-4 w-4 text-success" />}
                  ...
                  <div className="mt-6 pt-6 border-t border-neutral-200">
                    <Quote className="h-6 w-6 text-neutral-300 mb-2" />
                    <p className="text-sm text-neutral-700 italic">{study.quote}</p>
                    <p className="mt-3 text-sm font-medium text-neutral-900">{study.author}</p>
      ...
      {/* Testimonials */}
      <section className="bg-neutral-50 px-4 py-32 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-neutral-900 sm:text-4xl tracking-tight">
      ...
      <section className="px-4 py-32 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 flex justify-center">
            <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-card border border-neutral-200">
              <h3 className="text-lg font-semibold text-neutral-900">Professional</h3>
              <div className="mt-4 flex items-baseline">
                <span className="text-4xl font-bold text-neutral-900">$149</span>
                <span className="ml-2 text-neutral-500">/month</span>
                <span className="ml-3 text-lg text-neutral-400 line-through">$249</span>
              </div>
